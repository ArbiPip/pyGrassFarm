...
def bot_info(name: str = ""):
    ...
    print(
        f"{colored('pyGrassFarm v0.9.9 <crypto/> moves:', color='light_yellow')} "
        f"{colored('https://t.me/+zwYmIO6tBJVkOTQy', color='light_green')}"
    )
    print(
        f"{colored('Donate here:', color='light_yellow')} "
        f"{colored('0x05b84C97167cda9C7D8c77d7E1698ce9B4F9B393', color='light_green')}"
    )
